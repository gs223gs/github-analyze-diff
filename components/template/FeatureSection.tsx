...
const features: Feature[] = [
  {
    ...
    title: "GitHub統計",
    description: "フォロワー数、スター数、コントリビューション、使用言語などを表示",
    bgColor: "bg-black dark:bg-white",
  },
  {
    icon: <span className="text-white font-bold text-2xl">Z</span>,
    title: "Zenn活動",
    description: "記事数、いいね数、フォロワー数、本の執筆状況を可視化",
    bgColor: "bg-blue-500",
  },
  {
    icon: <span className="text-white font-bold text-2xl">Q</span>,
    title: "Qiita貢献",
    description: "記事数と貢献度を分かりやすく表示",
    bgColor: "bg-green-500",
  },
  {
    icon: <span className="text-white font-bold text-2xl">A</span>,
    title: "AtCoderレート",
    description: "アルゴリズムとヒューリスティックのレーティングを表示",
    bgColor: "bg-gray-700",
  },
];
