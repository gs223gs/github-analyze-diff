      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-12">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">GitHub</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">フォロワー数</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 transform hover:-translate-y-1">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">スター数</h3>
              <Image
        ...
        <section className="mb-12">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Zenn</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">記事数</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">いいね数</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">フォロワー</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">本の数</h3>
              <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Qiita</h2>
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">貢献度</h3>
                  <Image
            ...
            <div>
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">AtCoder</h2>
              </div>
              
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">Algorithm</h3>
                  <Image
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
                  <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-3">Heuristic</h3>
                  <Image
        ...
        {/* トロフィー セクション */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">🏆 GitHub トロフィー</h2>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 overflow-x-auto">
            <Image
              src={`https://github-profile-trophy.vercel.app/?username=${user}&theme=${theme.includes('dark') ? 'darkhub' : 'flat'}&column=7&margin-w=15&margin-h=15`}
        ...
        {/* 統計情報 セクション */}
        <section>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">📊 詳細統計</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">最も使用している言語</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">プロフィール詳細</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">GitHub統計</h3>
              <Image
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">アクティブ時間</h3>
              <Image
